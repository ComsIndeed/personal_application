...
class _NotesInputState extends State<NotesInput> {
  ...
  void _onTextChanged() {
    context.read<NotesCubit>().updateText(_textController.text);
  }
  ...
  void _addFiles(
    ...
    if (newFiles != null && newFiles.isNotEmpty) {
      context.read<NotesCubit>().updateFiles([...currentFiles, ...newFiles]);
    }
  }
  ...
  Future<void> _handlePaste(List<PlatformFile> currentFiles) async {
    ...
    if (imageBytes != null) {
      ...
      final fileName =
          'pasted_note_image_${DateTime.now().millisecondsSinceEpoch}.png';
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return FilePreviewItem(
                            ...
                            onRemove: () {
                              ...
                              context.read<NotesCubit>().updateFiles(newFiles);
                            },
                          );
                        },
                      ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      _SideButton(
                        ...
                        isOutlined: false,
                        onPressed: () => context.read<NotesCubit>().sendRaw(),
                      ),
                    ],
                  ),
                ],
